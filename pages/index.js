...
function Home({ changeTheme, theme }) {
  ...
  const [search, setSearch] = useState('opulent')
        ...
        <div className={theme.palette.type === 'dark' ? classes.containerDark : classes.container}>
          {/* <div className={classes.copyContainer}>
            <div className={classes.copyCentered}>
              <Typography variant='h1' className={classes.chainListSpacing}><span className={classes.helpingUnderline}>Opulent-X Gateway</span></Typography>
              <Typography variant='h2' className={classes.helpingParagraph}>Welcome to Opulent-X BETA</Typography>
              <Typography className={classes.subTitle}>Blockchain for Entrepreneur, Technologies and Adventurists is an emerging blockchain network.</Typography>
              <Button
                size='large'
                color='primary'
                variant='contained'
              ...
              <div className={classes.socials}>
                <a className={`${classes.socialButton}`} href='https://github.com/FrancoMuniz/networklist-org' target='_blank' rel="noopener noreferrer" >
                ...
                <Typography variant='subtitle1' className={classes.originalProject}>
                  <a className={`${classes.socialButton}`} href='https://github.com/antonnell/networklist-org.git' target='_blank' rel="noopener noreferrer" >
                    Original project by Chainlist
                  </a>
                </Typography>
              </div>
              <div className={classes.socials}>
                <a className={`${classes.socialButton}`} href='https://twitter.com/chain_directory' target='_blank' rel="noopener noreferrer" >
